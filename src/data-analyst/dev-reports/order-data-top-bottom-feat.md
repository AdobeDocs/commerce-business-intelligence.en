...
![Show Top/Bottom feature in the Visual Report Builder.]({% link images/Show_Top_Bottom.png %}){:.zoom}
...
![Strange and unhelpful report results.]({% link images/Screen_Shot_2015-12-17_at_3.53.13_PM.png %}){:.zoom}

If we had sorted both metrics by the grouping, the chart would look like this:

![Sorting both metrics by the grouping.]({% link images/Screen_Shot_2015-12-17_at_3.55.29_PM.png %}){:.zoom}
...
![Ordering by the metric.]({% link images/Ordered_by_metric.png %}){:.zoom}
...
![Ordering by the grouping.]({% link images/Ordered_by_grouping.png %}){:.zoom}
