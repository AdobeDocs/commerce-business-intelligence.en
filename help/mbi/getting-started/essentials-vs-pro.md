...
The following table describes elements included with a legacy `Essentials` account versus a current Commerce Intelligence account. Adobe no longer offers `Essentials`.
