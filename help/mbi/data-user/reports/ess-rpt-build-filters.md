...
1. In the left panel, click the **Filters** (![]({% link images/magento-bi-btn-filter.png %})) icon.

    ![]({% link images/magento-bi-report-builder-filter-add.png %}){: .zoom}
    *Add Filter*
...
1. Click <span class="btn">Add Filter</span>.
    ...
    * When the filter is complete, click **Apply**.
        ...
        ![]({% link images/magento-bi-report-builder-filter-report.png %}){: .zoom}
        *Filtered Report*

1. In the sidebar, click the **Perspective** ( ![]({% link images/magento-bi-btn-perspective.png %})) icon.

    ![]({% link images/magento-bi-report-builder-filter-perspective.png %}){: .zoom}
    *Perspective*

1. In the list of settings, choose **Cumulative**. Then, click <span class="btn">Apply</span>.

    ![]({% link images/magento-bi-report-builder-filter-perspective-cumulative.png %}){: .zoom}
...
1. Enter a **Title** for the report and **Save** it as a **Chart** to your dashboard.
    ...
    ![]({% link images/magento-bi-report-builder-filter-perspective-cumulative-save.png %}){: .zoom}
    *Save to Dashboard*
