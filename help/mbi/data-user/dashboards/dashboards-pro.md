...
For the _Customers_ and _Executive Summary_ dashboards, some reports are only available depending on your store's checkout configuration. Specifically, if your store allows guest checkout or does not allow guest checkout.
