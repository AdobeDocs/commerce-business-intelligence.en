...
While you can directly connect your database to [!DNL Commerce Intelligence] using database credentials, Adobe recommends you use a proven encryption method like an SSH tunnel. This ensures that your data stays safe and secure as it makes its way into your Data Warehouse. For SSH host key enrollment, errors, and troubleshooting, see [SSH host key verification](../integrations/ssh-host-key-verification.md).
...
After you connect sources, you may want to automate a basic health check to confirm that full updates are completing. Use the [Update Cycle Status API](https://developer.adobe.com/commerce/services/reporting/update-cycle/) in the developer documentation to fetch the most recent completed update cycle for your client and display it in internal dashboards or alerts.
