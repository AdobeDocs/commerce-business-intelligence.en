...
Before you can upload your data into MBI, check that it's formatted according to the guidelines in this section.
...
Now that your spreadsheet is correctly formatted and MBI-friendly, let's add it to your data warehouse.
...
1. Click the **Choose File** button and select the file. Click **Open** to start the upload.
   ...
   After the upload completes, you'll see a list of the columns MBI found in your file.
...
Got some new data to add to a file you've already uploaded? No problem - you can easily update and append data in MBI.
