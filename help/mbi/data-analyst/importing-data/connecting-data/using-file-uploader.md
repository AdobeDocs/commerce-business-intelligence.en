...
Some special characters are not accepted. For example, the pipe symbol `& # 1 2 4` is interpreted as creating a new column and will cause errors when uploading a file.
