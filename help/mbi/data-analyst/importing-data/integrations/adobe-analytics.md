...
1. Inform the [!DNL Commerce Intelligence] [Support team](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies) that your integration is authorized, and they run the initial connection process for you.
