...
Let us get started by entering our [!DNL Google Analytics] credentials into [!DNL MBI]:
...
1. Click the [!DNL Google Analytics] icon. This will open the [!DNL Google Analytics] credentials page.
