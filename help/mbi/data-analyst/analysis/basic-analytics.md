...
* **Report example**: Number of 2nd and 3rd purchases placed last year
   ...
   * **Group By**: Customer's Order Number, then select 2 and 3
   ...
   ![](../../mbi/assets//2nd_and_3rd_purchases_last_year.png)
...
* **Report example 2**:  Number of repeat customers last year
   ...
   * **Time Interval**: By Month
   ...
   ![Repeat Customers Last Year](../../mbi/assets//Repeat_customers_last_year.png)<!--{: width="929"}-->
...
* **Metric Used**: Orders
   ...
   * **Show Top/Bottom**: Top 25 sorted by Orders
   ...
   ![Top 25 Customers by Orders](../../mbi/assets//Top_25_customers_by_lifetime_orders.png)<!--{: width="929"}-->
...
* **Report example**: Top 25 customers by Lifetime Revenue
   ...
   * **Show Top Bottom**: Top 25 sorted by Lifetime Revenue
   ...
   ![Top 25 Customers by Revenue](../../mbi/assets//top_25_customers_by_lifetime_revneue.png)<!--{: width="929"}-->
...
* **Report example**: Average Customer Lifetime Revenue by Cohort
   ...
   * **Perspective**: Cumulative Average Value Per Cohort Member
   ...
   ![Customer Lifetime Revenue by Cohort](../../mbi/assets//Avg_customer_lifetime_revenue_by_cohort.png)<!--{: width="929"}-->
...
* **Report example**: Coupon and non coupon customers by month
   ...
   * **Time interval**: By Month
   ...
   ![Customers by Coupon Usage](../../mbi/assets//Customers_by_coupon_usage.png)<!--{: width="929"}-->
...
* **Report example 2**: Percent of Coupon and Non coupon customers by month
   ...
   * **Note**: Hide all metrics
   ...
   ![Coupon Usage](../../mbi/assets//Customers_by_coupon_usage_formula.png)<!--{: width="929"}-->
...
![Average First 30 Day Revenue](../../mbi/assets//Avg_first_30_day_revenue.png)<!--{: width="929"}-->
...
![Customer Lifetime Revenue](../../mbi/assets//Avd_customer_lifetime_revenue_.png)<!--{: width="929"}-->
...
* **Report Example**: Revenue by month, YTD
   ...
   * **Tip** Make sure your revenue metric's calculation is consistent with the definition that you discuss internally. For example, you may only want to count revenue from orders that have been shipped, you might need to convert currencies from different regions, and you may want to exclude tax. Further, you can use [Filter Sets](../../data-user/reports/ess-manage-data-filters.md) to ensure consistency across all metrics built on the same table.
   ...
   ![Revenue](../../mbi/assets//revenue.png)<!--{: width="929"}-->
...
* **Report example**: Orders by month, YTD
   ...
   * **Tip** Just like the revenue metric, you should have [Filter Sets](../../data-user/reports/ess-manage-data-filters.md) in place to exclude incomplete, test, or returned orders.
   ...
   ![Orders](../../mbi/assets//orders_pic.png)<!--{: width="929"}-->
...
* **Report example**: Items sold by month, YTD
   ...
   * **Time Interval**: By Month
   ...
   ![Products Ordered](../../mbi/assets//products_ordered_pic1.png)<!--{: width="929"}-->
...
* **Report example**: Products per order: 1st order vs repeat orders
   ...
   * **Notes**: Uncheck the **Multiple Y-Axes box** and **Hide** all metrics
   ...
   ![Products Ordered 2](../../mbi/assets//products_ordered_pic2.png)<!--{: width="929"}-->
...
* **Report example**: AOV vs previous year, YTD
   ...
   * **Perspective**: Amount Change vs Previous Year
   ...
   ![AOV](../../mbi/assets//aov_pic.png)<!--{: width="929"}-->
...
* **Report example**: Products most purchased with coupons
   ...
   * **Show top/bottom**: Top 25 sorted by Products ordered
   ...
   ![Products with Coupons](../../mbi/assets//prod_coupons_pic.png)<!--{: width="929"}-->
...
* **Report example**:
   ...
   * **Metric 2**: > 3 orders
   ...
   ![Time Between Orders](../../mbi/assets//time_bw_orders_pic.png)<!--{: width="929"}-->
...
![Ad Spend](../../mbi/assets//ad_spend.png)<!--{: width="929"}-->
...
* **Report Example**: Add impressions and ad clicks by day
   ...
   * **Time Interval**: By Day
   ...
   ![Ad Impressions](../../mbi/assets//ad_impressions.png)<!--{: width="929"}-->
...
* **Report Example**: CTR by campaign
   ...
   * **Notes**: You can **title** the formula as "CTR", and **hide** all metrics.
   ...
   ![CTR](../../mbi/assets//CTR.png)<!--{: width="929"}-->
...
* **Report Example**: CPC by campaign
   ...
   * **Notes**: You can **title** the formula as "CPC", and **hide** all metrics.
   ...
   ![CPC](../../mbi/assets//CPC.png)<!--{: width="929"}-->
...
* **Report Example**: Customers by acquisition source
   ...
   * **Notes**: Check out [this article](../analysis/most-value-source-channel.md) for more examples of reports using acquisition source.
   ...
   ![Acquisition Source](../../mbi/assets//acquisition_source.png)<!--{: width="929"}-->
...
* **Report Example**: Customers by acquisition campaign with paid medium
   ...
   * **Note**: For the filter in your New Customers metric, you can add any other mediums that are considered "paid" mediums for your business such as cpc or paid search.
   ...
   ![Acquisition Medium](../../mbi/assets//acquisition_medium.png)<!--{: width="929"}-->
...
![CAC 1](../../mbi/assets//New_Users_Last_Month.png)<!--{: width="929"}-->

![CAC 2](../../mbi/assets//CAC_2.png)<!--{: width="929"}-->
...
* **Report Example**: To create this report, first add the New customers metric. Then, add the Average lifetime revenue metric. Select the desired time frame and choose the interval as None. Finally, select the group by option as Customer's first order's campaign.
   ...
   * **Notes**: For the two filters, you can add any other mediums that are considered "paid" mediums for your business such as cpc or paid search, and you can add any other sources you would like to analyze such as Facebook. Also, check out [this article](../analysis/roi-ad-camp.md) for more details on CAC, LTV, and ROI.
   ...
   ![Lifetime value by acquisition source, medium, and campaign](../../mbi/assets//LTV_2.png)<!--{: width="929"}-->
...
* **Report Example**: ROI by campaign
   ...
   * **Notes**: You can title the formula as "ROI", and Hide all metrics. In addition, you can adjust the filters in the metrics to analyze alternative sources and mediums. Also, check out [this article](../analysis/roi-ad-camp.md) for more details on CAC, LTV, and ROI.
   ...
   ![ROI 1](../../mbi/assets//ROI_1.png)<!--{: width="929"}-->

   ![ROI 2](../../mbi/assets//ROI_2.png)<!--{: width="929"}-->
