...
description: Review the quote_item table schema in Commerce Intelligence, which tracks every cart item. Learn Adobe's recommendations for managing table size over time.
