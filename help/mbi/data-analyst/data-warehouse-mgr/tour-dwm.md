...
* The data source is a database and the MBI user you created doesn't have access. In this case, you or your database administrator will need to grant access.
