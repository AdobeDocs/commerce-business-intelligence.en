...
description: Learn how data is generated, what exactly causes a new row to be inserted into one of the Core Commerce how are actions such as making a purchase or creating an account recorded into the Commerce database.
