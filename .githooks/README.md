...
- **GIF**: Uses `gifsicle`
- **SVG**: SVG optimization is disabled by default (can break complex vector graphics and animations), but checked against a 140 KB size limit
...
**Note**: SVG optimization is disabled by default (can break complex vector graphics and animations).
