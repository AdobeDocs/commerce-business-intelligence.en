...
For more examples, search in closed pull requests in the repository to see how existing highlights are formatted, and compare them with the [What's New section](https://experienceleague.adobe.com/en/docs/commerce-operations/operational-guides/home#whats-new) to see how they appear in the documentation.
